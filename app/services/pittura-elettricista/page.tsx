"use client";
import { Paintbrush, Zap, Phone, ArrowLeft, Lightbulb } from "lucide-react";
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-start">
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {features.map((item, i) => (
                <div key={i} className="bg-gray-50 p-5 md:p-6 rounded-3xl border border-gray-100 hover:shadow-lg transition-all">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            <div className="rounded-3xl md:rounded-[2.5rem] overflow-hidden shadow-2xl border-4 md:border-8 border-gray-50 h-72 sm:h-80 lg:h-[400px]">
              <img 
            ...
            <div className="bg-brand-navy rounded-3xl md:rounded-[2.5rem] p-6 sm:p-8 md:p-10 text-white shadow-2xl relative overflow-hidden group">
