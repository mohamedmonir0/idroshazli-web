    ...
    <div className="min-h-screen bg-white pt-28 md:pt-32 pb-16 md:pb-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10 md:mb-16">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-brand-navy mb-6 uppercase leading-none">Chi <span className="text-brand-orange">Siamo</span></h1>
          <p className="text-base sm:text-xl text-gray-500 italic leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mb-12 md:mb-20 text-center">
          <div className="p-6 md:p-8 bg-gray-50 rounded-3xl md:rounded-[2.5rem]">
        ...
        <div className="bg-brand-navy text-white p-6 sm:p-8 md:p-12 rounded-3xl md:rounded-[3rem] shadow-2xl relative overflow-hidden">
          <h2 className="text-2xl sm:text-3xl font-black mb-6 italic">La nostra missione</h2>
          <p className="text-gray-300 leading-relaxed italic">
            &ldquo;Fornire un servizio idraulico di eccellenza, risolvendo ogni emergenza in tempi record e trasformando le case dei nostri clienti con ristrutturazioni di lusso e impianti a norma.&rdquo;
          </p>
        </div>
      </div>
    </div>
