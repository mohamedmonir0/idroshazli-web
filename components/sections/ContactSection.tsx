export default function ContactSection() {
  return (
    <section className="py-16 md:py-20 px-4 bg-brand-navy">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl md:rounded-[2.5rem] p-5 sm:p-8 md:p-10 text-brand-navy shadow-2xl">
        <h2 className="text-2xl sm:text-3xl font-black text-center mb-2">Hai un&apos;emergenza?</h2>
        ...
        <form className="space-y-5">
          ...
          <div className="border-2 border-dashed border-brand-sky/30 bg-brand-sky/5 p-5 sm:p-8 rounded-2xl text-center cursor-pointer hover:bg-brand-sky/10 transition-all">
          ...
          <button className="w-full bg-brand-orange text-white py-4 sm:py-5 rounded-2xl font-black text-base sm:text-xl shadow-xl hover:bg-orange-600 transition-all">
            INVIA RICHIESTA ORA
          </button>
        </form>
      </div>
