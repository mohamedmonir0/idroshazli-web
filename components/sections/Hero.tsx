    ...
    <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl px-6">
        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }}>
          <h1 className="text-white text-6xl md:text-8xl font-black mb-4">
            IDRO<span className="text-brand-sky">SHAZLI</span>
          </h1>
          <p className="text-white/90 text-xl md:text-2xl max-w-xl mb-8 leading-relaxed font-light">
          ...
          <div className="flex gap-4">
            <a href="#contact" className="bg-brand-orange text-white px-10 py-4 rounded-full font-black hover:scale-105 transition-all">
              CONTATTACI ORA
            </a>
          </div>
        </motion.div>
