  ...
  return (
    <section id="servizi" className="py-24 bg-white">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl font-black text-brand-navy mb-16 uppercase italic">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {services.map((s, i) => (
            <Link href={`/services/${s.slug}`} key={i} className="group h-full">
              <motion.div whileHover={{ y: -10 }} className="bg-white rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 h-full flex flex-col cursor-pointer">
